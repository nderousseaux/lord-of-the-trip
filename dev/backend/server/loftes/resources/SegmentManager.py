    ...
    if segment != None:
        ...
        if challenge.map_url != None and challenge.map_url != "":
            ...
            try:
                ...
                start = {"position_x": start_crossing_point.position_x, "position_y": start_crossing_point.position_y}
                list_coordinates.insert(0, start)

                end = {"position_x": end_crossing_point.position_x, "position_y": end_crossing_point.position_y}
                ...
                for i in range(0, n):
                    ...
                    point_length = calculate_length_between_two_points(
                        list_coordinates[i], list_coordinates[i + 1], challenge.scalling, map_heigth
                    )
