...
def fill(argv=sys.argv):
    ...
    cp3 = CrossingPoint(name='La passe du magicien',
                        challenge_id='1',
                        position_x='0.20',
                        position_y='0.40')
    session.add(cp3)
    ...
    cp4 = CrossingPoint(name='Le carrousel des ours',
                        challenge_id='1',
                        position_x='0.30',
                        position_y='0.40')
    session.add(cp4)
    ...
    cp5 = CrossingPoint(name='Le pont des centaures',
                        challenge_id='1',
                        position_x='0.30',
                        position_y='0.50')
    session.add(cp5)
    ...
    cp6 = CrossingPoint(name='Le pont de la sorcière',
                        challenge_id='1',
                        position_x='0.20',
                        position_y='0.50')
    session.add(cp6)
    ...
    cp9 = CrossingPoint(name='Cair Paravel',
                        challenge_id='1',
                        position_x='0.20',
                        position_y='0.50')
    session.add(cp9)
