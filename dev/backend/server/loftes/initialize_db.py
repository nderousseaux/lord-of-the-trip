...
def fill(argv=sys.argv):
    ...
    #Challenge
    cp1 = CrossingPoint(name='L\'armoire',
                        challenge_id='1',
                        position_x='0.142',
                        position_y='0.324511')
    session.add(cp1)
    ...
    cp2 = CrossingPoint(name='La passe du faune',
                        challenge_id='1',
                        position_x='0.524667',
                        position_y='0.335221')
    ...
    cp3 = CrossingPoint(name='Le nid des griffons',
                        challenge_id='1',
                        position_x='0.794001',
                        position_y='0.262905')
    session.add(cp3)
    ...
    cp4 = CrossingPoint(name='Le pont des centaures',
                        challenge_id='1',
                        position_x='0.508841',
                        position_y='0.485851')
    session.add(cp4)
    ...
    cp6 = CrossingPoint(name='L\'antre du dragon',
                        challenge_id='1',
                        position_x='0.477333',
                        position_y='0.665706')
    session.add(cp6)
    ...
    cp7 = CrossingPoint(name='Cair Paravel',
                        challenge_id='1',
                        position_x='0.746667',
                        position_y='0.480433')
    session.add(cp7)
    ...
    cp8 = CrossingPoint(name='La table de pierre',
                        challenge_id='1',
                        position_x='0.2',
                        position_y='0.5')
    session.add(cp8)
    ...
    cp9 = CrossingPoint(name='Le pont de la sorcière',
                        challenge_id='1',
                        position_x='0.615334',
                        position_y='0.615723')
    session.add(cp9)
    ...
    s2 = Segment(name='La traversée du grand désert',
    ...
    s3 = Segment(name='La traversée des monts',
                start_crossing_point_id='1',
    ...
    s4 = Segment(name='La route d\'Ettinsmoor',
    ...
    s5 = Segment(name='Vers le nid des aigles',
    ...
    s6 = Segment(name='A la table de pierre',
                start_crossing_point_id='1',
    ...
    s7 = Segment(name='A la table de pierre 2',
    ...
    s8 = Segment(name='A la table de pierre 3',
    ...
    s9 = Segment(name='Fuyons la sorcière',
    ...
    s10 = Segment(name='Vers le chateau sorcière',
                start_crossing_point_id='5',
                end_crossing_point_id='4',
                challenge_id='1',
    ...
    s11 = Segment(name='Suivons Mr thimus',
                start_crossing_point_id='4',
                end_crossing_point_id='3',
                challenge_id='1',
    ...
    s12 = Segment(name='Vers le chateau sorcière 2',
